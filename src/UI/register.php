                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <label class="cursor-pointer">
                            ...
                            <div class="border-2 border-gray-600 peer-checked:border-cus-primary peer-checked:bg-cus-primary peer-checked:bg-opacity-10 rounded-lg p-4 transition-all">
                                <div class="flex items-center mb-2">
                                    <svg class="w-8 h-8 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M18 3a1 1 0 00-1.196-.98l-10 2A1 1 0 006 5v6.114a4 4 0 10.327 7.573A1 1 0 007 18V9.114l8-1.6V13.86a4 4 0 10.327 3.74A1 1 0 0016 17V3z"></path>
                                    </svg>
                                    <h4 class="font-semibold text-white">Artist</h4>
                                </div>
                                <p class="text-sm text-cus-gray">
                                    Upload and share your music with listeners. Requires admin approval.
                                </p>
                            </div>
                        </label>
                    </div>
